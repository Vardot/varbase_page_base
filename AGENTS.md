...
Guidance for AI coding agents working on the Varbase Page Base recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_page_base](https://git.drupalcode.org/project/varbase_page_base/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_page_base](https://www.drupal.org/project/issues/varbase_page_base)
